...
{   
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="INSERT INTO tblnotice(noticeTitle,noticeDetails) VALUES(:noticeTitle,:noticeDetails)";
...
<html lang="en">
    <head>
        ...
        <title>SRMS Admin | Add Notification</title>
                                            ...
                                            <div class="panel-body">
                                                <form class="form-horizontal" method="post">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" name="noticetitle" class="form-control" id="noticetitle" placeholder="Notification Title" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="default" class="col-sm-2 control-label">Notification Details</label>
                                                        <div class="col-sm-10">
                                                            <textarea name="noticedetails" class="form-control" id="noticedetails" rows="5" placeholder="Notification Details" required="required"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
