...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
    <a href="edit-result.php?stid=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-primary btn-sm">
        <i class="fa fa-edit"></i> Edit
    </a>
    <a href="view-result.php?stid=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-info btn-sm">
        <i class="fa fa-eye"></i> View
    </a>
    <a href="delete-result.php?stid=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this result?');">
        <i class="fa fa-trash"></i> Delete
    </a>
    <a href="print-result.php?stid=<?php echo htmlentities($result->StudentId); ?>" class="btn btn-success btn-sm" target="_blank">
