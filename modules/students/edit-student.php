...
{   
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="UPDATE tblstudents SET StudentName=:studentname, RollId=:roolid, StudentEmail=:studentemail, Gender=:gender, ClassId=:classid, DOB=:dob, Status=:status WHERE id=:stid";
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select name="class" class="form-control" id="default" required="required">
                                                                <option value="<?php echo htmlentities($result->ClassId)?>"><?php echo htmlentities($result->ClassName)?> (<?php echo htmlentities($result->Section)?>)</option>
                                                                ...
                                                                {   ?>
                                                                <option value="<?php echo htmlentities($res->id); ?>"><?php echo htmlentities($res->ClassName); ?>&nbsp; Section-<?php echo htmlentities($res->Section); ?></option>
                                                                <?php }} ?>
                                                            </select>
                                                        </div>
                                                    </div>
